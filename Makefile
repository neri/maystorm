...
run: 
	qemu-system-x86_64 -machine q35 -cpu max -smp 4,cores=2,threads=2 -bios $(OVMF) -drive format=raw,file=fat:rw:$(MNT) -rtc base=localtime,clock=host -monitor stdio -device nec-usb-xhci,id=xhci
