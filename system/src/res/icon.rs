...
use crate::r;
use megstd::drawing::{image::ImageLoader, *};
    ...
    pub fn bitmap(icon: r::Icons) -> Option<OwnedBitmap> {
        match icon {
            ...
            r::Icons::Cancel => ImageLoader::from_qoi(include_bytes!(
                "../../../assets/material-design-icons/ic_cancel_black_24dp.qoi"
            )),
            r::Icons::Check => ImageLoader::from_qoi(include_bytes!(
                "../../../assets/material-design-icons/ic_check_black_24dp.qoi"
            )),
            r::Icons::ChevronLeft => ImageLoader::from_qoi(include_bytes!(
                "../../../assets/material-design-icons/ic_chevron_left_black_24dp.qoi"
            )),
            r::Icons::ChevronRight => ImageLoader::from_qoi(include_bytes!(
                "../../../assets/material-design-icons/ic_chevron_right_black_24dp.qoi"
            )),
            r::Icons::Close => ImageLoader::from_qoi(include_bytes!(
                "../../../assets/material-design-icons/ic_close_black_24dp.qoi"
            )),
            r::Icons::Delete => ImageLoader::from_qoi(include_bytes!(
                "../../../assets/material-design-icons/ic_delete_black_24dp.qoi"
            )),
            r::Icons::Error => ImageLoader::from_qoi(include_bytes!(
                "../../../assets/material-design-icons/ic_error_black_24dp.qoi"
            )),
            r::Icons::Menu => ImageLoader::from_qoi(include_bytes!(
                "../../../assets/material-design-icons/ic_menu_black_24dp.qoi"
            )),
            r::Icons::Info => ImageLoader::from_qoi(include_bytes!(
                "../../../assets/material-design-icons/ic_info_outline_black_24dp.qoi"
            )),
            r::Icons::Usb => ImageLoader::from_qoi(include_bytes!(
                "../../../assets/material-design-icons/ic_usb_black_24dp.qoi"
            )),
            r::Icons::Warning => ImageLoader::from_qoi(include_bytes!(
                "../../../assets/material-design-icons/ic_warning_black_24dp.qoi"
            )),
        }
    }
